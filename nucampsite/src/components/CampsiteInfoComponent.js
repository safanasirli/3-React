...
import { Card, CardImg, CardText,Button, CardBody, Breadcrumb, BreadcrumbItem, Modal, ModalHeader, ModalBody} from 'reactstrap';
                    ...
                    <ModalBody>
                        <LocalForm onSubmit={values=>this.handleSubmit(values)}>
                            ...
                            <div className="form-group">
                                ...
                                <Control.textarea model=".text" id="text"  name="text" className="form-control" row="6"></Control.textarea>
                            </div>
